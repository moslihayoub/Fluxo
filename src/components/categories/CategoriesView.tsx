...
function CategoryDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      {/* Side Drawer */}
      <div className="fixed inset-y-0 right-0 z-50 w-full sm:w-[50%] max-w-xl bg-white dark:bg-zinc-900 shadow-2xl flex flex-col border-l border-zinc-200 dark:border-zinc-800 animate-in slide-in-from-right duration-200">
        {/* Header */}
        <div className="p-6 border-b border-zinc-100 dark:border-zinc-800 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center">
              <Tag className="w-5 h-5 text-zinc-900 dark:text-white" />
            </div>
            <div>
              ...
              <p className="text-xs text-zinc-500">
                {category ? 'Modifier les propriétés de la catégorie' : 'Créer une nouvelle catégorie pour vos opérations'}
              </p>
            </div>
          </div>
          <button 
        ...
        {/* Body Form */}
        <form id="category-form" onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto flex-1">
          <div>
            ...
            <input
              ...
              placeholder="Ex: Encaissement client, Loyer, Abonnement..."
              className="w-full px-3.5 py-2.5 rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white text-sm placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-zinc-900 dark:focus:ring-white transition-shadow"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3.5 py-2.5 pr-10 rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white text-sm placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-zinc-900 dark:focus:ring-white transition-shadow font-mono"
              />
        ...
        <div className="p-4 border-t border-zinc-100 dark:border-zinc-800 flex justify-end gap-3 bg-zinc-50 dark:bg-zinc-800/40">
          ...
          >
            {category ? <><CheckCircle2 className="w-4 h-4" /> {t('common.save')}</> : <><Plus className="w-4 h-4" /> {t('common.add')}</>}
          </button>
        </div>
      </div>
    </div>
              ...
              return (
                <div key={op.id} className="flex items-center justify-between px-4 py-3 hover:bg-zinc-50 dark:hover:bg-zinc-800/30 transition-colors">
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <button onClick={() => setEditingOp(op)} className="p-1.5 text-zinc-400 hover:text-zinc-900 dark:hover:text-white rounded-md bg-zinc-100 dark:bg-zinc-800 transition-colors">
                ...
                <div className="hidden sm:grid group grid-cols-12 gap-2 px-4 py-3.5 items-center hover:bg-zinc-50 dark:hover:bg-zinc-800/30 transition-colors">
                  ...
                  <div className="col-span-2 text-right">
                    <span className="text-xs font-mono tabular-nums text-zinc-600 dark:text-zinc-300">
                      {cat.defaultAmount_cents !== undefined ? formatCurrency(cat.defaultAmount_cents || 0) : '—'}
                    </span>
                  </div>
